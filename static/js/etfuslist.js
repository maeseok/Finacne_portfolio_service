List = [
  ...
  "Direxion Dly Semiconductor Bull 3X",
  "iShares Barclays US Treasury Bond",
  ...
  "SPDR Consumer Discr. Select Sector",
  "Direxion Daily Small Cap Bear 3X Shares",
  "SPDR Barclays Interm. Term Bond",
  "SPDR BloomBarclays Short Term High Yield Bond",
  ...
  "Invesco Preferred",
  "Vanguard Tax-Exempt Bond Index Fund Shares",
  "Schwab Emerging Markets Equity",
  "Vanguard REIT",
  "SPDR Blackstone GSO Sen Loan",
  "United States Oil Fund",
  "iShares Trust DJ US Real Estate",
  ...
  "Direxion Dly Semiconductor Bear 3X",
  ...
  "ProShares UltraSh. DJUBS Ntrl Gas",
  ...
  "iShares DJSU Home Construction",
  "SPDR S&P Retail",
  "iShares S&P National Mun Bond",
  ...
  "Direxion Gold Miners Index Bear 3X",
  ...
  "Schwab U.S. REIT",
  "Direxion Daily Jr Gld Mnrs Bear 3X",
  ...
  "FirstTrust Value Line Dividend",
  ...
  "Direxion 20-Yr Tr. Bull 3X Shrs",
  "Direxion Daily Technology Bull 3X",
  "Vanguard Intermediate-Term Bond",
  "iShares S&P Midcap 400",
  "Global X Uranium",
  "iShares 0-5 Y High Yld Corp Bd",
  ...
  "iShares S&P SmallCap 600 Values",
  "ProShares Short 20+ Year Treasury",
  "SPDR Cap. Invest Grade Float Rate",
  ...
  "SPDR Wilshire Global Real Estate",
  ...
  "Direxion 20+ YR Treas. Bear 3X",
  "iShares S&P North Amer. Nat. Res.",
  "iShares MSCI South Africa",
  "Schwab Fdmtl Emerg Mkts Lg Co",
  "iBoxx 3-Y Target Dur. TIPS",
  "VanEck Merk Gold Trust",
  "Vanguard Extended Market",
  "Vanguard Pacific",
  "Invesco S&P 500 Pure Value",
  "iShares MSCI USA Momentum Factor",
  "FirstTrust Morningstar",
  "SPDR Nuveen Bloomberg Barclays High Yield Municipa",
  ...
  "EMQQ The Emerging Markets Internet & Ecommerce",
  ...
  "FirstTrust Materials AlphaDEX Fund",
  "iShares Global REIT",
  "iShares DJ Transport Average Index",
  "Vanguard Health Care",
  "Invesco Taxable Municipal Bond",
  "Vanguard Telecom",
  "VanEck Short High-Yield Muni",
  "iShares MSCI Poland Inve. Mrkt",
  "iShares Currency Hedged MSCI Japan",
  "SPDR S&P Pharmaceuticals",
  "FirstTrust North Am. Energy Infr.",
  "Mega Cap 300 Value",
  "FirstTrust Financials AlphaDEX",
  "WisdomTree Japan Hedged Equity",
  "Teucrium Corn",
  "Invesco China Technology",
  "SPDR Barclays Convertible Bond",
  "Vanguard Long Term Bond",
  "Global X Copper Miners",
  "iShares DJSU Aerospace & Defense",
  ...
  "SPDR S&P Oil & Gas Eq & Services",
  "FirstTrust S&P REIT Index Fund",
  "Vanguard Utilities",
  "iShares S&P Global Technology",
  "Rogers Intl Commodity Agriculture",
  "FirstTrust Industrials AlphaDEX",
  ...
  "FirstTrust DJ Internet",
  "Tortoise North American Pipeline",
  "FirstTrust DJ Global Select Div.",
  ...
  "GLOBAL X MLP",
  "FlexShares STOXX Gbl Brd Infrs",
  "Invesco S&P 500 Equal Weight Consumer Discretionar",
  "ProShares UltraShort Silver",
  "iShares Edge MSCI Min Vol Global",
  "iShares S&P 100",
  "Global X MLP & Energy Infrs",
  "ProShares Short MSCI Emerging Mrkt",
  "ProShares Ultra Semiconductors",
  "Invesco Dynamic Leisure & Ent.",
  "Direxion Daily Real Estate Bull 3X Shares",
  "VanEck Vectors Agribusiness",
  "Hartford Developed Markets ex US",
  ...
  "ProShares UltraSh. Lehman 7-10 Y",
  ...
  "iShares DJ US Oil&Gas Exp. & Prod.",
  "Invesco Dynamic Energy E&P",
  "Invesco Aerospace & Defense",
  "MSCI Global Silver Miners Fund",
  "Invesco S&P SmallCap Value with Momentum",
  "ProShares Inv Grd-Intr Rt Hdgd",
  "ProShares Short 7-10 Year Treasury",
  "MSCI Global Agri. Producers Fund",
  "Rogers Intl Commodity Energy",
  "JPMorgan Diver Ret",
  ...
  "Deutsche X-trackers MSCI EAFE High Dividend Yield ",
  "Goldman Sachs ActiveBeta Emerging Markets Equity",
  "iShares S&P Global Con. Stap.",
  "WisdomTree LargeCap Dividend Fund",
  "iBoxx 5-Y Target Dur. TIPS",
  "Pacer Trendpilot 750",
  "United States Copper Index Fund",
  "iShares MSCI Frontier 100",
  "ETFMG Prime Cyber Security",
  "PowerSh. Dynamic Pharmaceuticals",
  "Invesco CurrencyShares Euro Currency Trust",
  "ProShares Ultra Technology",
  "Invesco S&P MidCap Quality",
  "iPath Bloomberg Commodity Index Total Return(SM)",
  ...
  "WisdomTree Emerging Mrkt SmallCap",
  "Vanguard Consumer Staples",
  "iShares Morningstar Small Growth",
  "SPDR S&P Intl SmallCap",
  ...
  "iShares Core Conser. Alloc",
  "iShares US Industrials",
  "Invesco Dynamic Build & Const.",
  "Global X China Consumer",
  "FirstTrust Cons. Discret. AlphaDEX",
  "First Trust Global Wind Energy",
  "iPath Series B Bloomberg Copper Subindex Total Ret",
  "VanEck Vectors Long Muni",
  "PIMCO 25+ Year Zero Coupon US Tr.",
  "Invesco CEF Income Composite",
  "Direxion Daily Emerging Markets Bull 3X Shares",
  "Pwshr S&P 4",
  "SPDR Multi-Asset Real Return",
  ...
  "Direxion Daily SK Bull 3X Shrs",
  "ALPS Sprott Gold Miners",
  "iShares Lehman 10-20 Y Tr. Bond",
  "iShares MSCI USA Multifactor",
  "Direxion Daily Pharmaceutical & Medical Bull 2X Sh",
  "iShares EM Local Currency Bond",
  ...
  "Direxion 10-Yr Tr. Bear 3X Shrs",
  ...
  "Direxion Daily CSI 300 China A Shar",
  ...
  "Invesco S&P MidCap Value with Momentum",
  "Invesco CurrencyShares Canadian Dollar Trust",
  "iShares MSCI ACWI Low Carbon Target",
  "First Trust Long/Short Equity",
  "Global X FTSE Norway 30",
  "SPDR FTSE/Macquarie GI 100",
  "Vanguard S&P Small-Cap 600 Value",
  "iPath Pure Beta Broad Commodity",
  ...
  "Direxion NQ-100 Equal Weighted",
  "SPDR S&P Emerging Markets Dividend",
  "Columbia EM Core ex-China",
  "ALPS Sprott Junior Gold Miners",
  "Vanguard S&P Mid-Cap 400",
  "iShares Yield Optimized Bond",
  "iShares S&P Global Cons.Discr.",
  "Cambria Foreign Shareholdr Yld",
  "ProShares Ultra Financials",
  "iPath Bloomberg Cocoa Subindex Total Return(SM)",
  "iShares MSCI Israel Cap Inv. Mrkt",
  "Morningstar DM X US Factor Tilt",
  "Global X FTSE ASEAN 40",
  "ALPS Medical Breakthroughs",
  "iShares Currency Hedged MSCI Emerging Markets",
  "FirstTrust DJ Select MicroCap",
  ...
  "ProShares UltraShort Semicon.",
  "iShares MSCI Norway Cap Inv. Mrkt",
  "Direxion Daily S&P 500 Bull 2X Shares",
  "WisdomTree Intl Real Estate Fund",
  "iShares MS Multi-Asset Income",
  "Invesco S&P 500 Equal Weight Industrials",
  "FlexShares Int Qual Div Dyn",
  "iShares MSCI USA Equal Weighted",
  "WisdomTree Intl LargeCap Dividend",
  "VanEck Vectors Africa",
  "ProShares Credit Suisse 130/30",
  "db X-trackers Muni Infras Revn",
  "Direxion 10-Yr Tr. Bull 3X Shrs",
  ...
  "ProShares UltraShort Consumer Ser.",
  "SPDR Barclays Short Term Intl Bond",
  "iShares MSCI Denmark Cap Inv. Mrkt",
  ...
  "Roundhill Acquirers Deep Value",
  "SPDR Barclays Intl Corp Bond",
  "Invesco Zacks Mid-Cap",
  "WBI Tactical LCS",
  "WisdomTree Intl MidCap Dividend",
  "WisdomTree Dreyfus Chinese Yuan",
  "Global X China Energy",
  "PowerShares DB Gold X2 Long",
  "PowerSh. Dynamic Biotech & Genome",
  ...
  "ProSh.UltraShort Consumer Goods",
  "Short Real Estate",
  ...
  "Global X Next Emer & Frontier",
  "First Trust Morningstar Futs Strat",
  ...
  "WisdomTree Dreyfus Emerging Curr.",
  "Global X China Industrials",
  "iShares Morningstar Small Core",
  "WBI BullBear Yield 3000",
  "SPDR MSCI ACWI Low Carbon Target",
  "Hartford Multifactor Small Cap",
  "iShares S&P Developed X US Prop.",
  "iShares iBds Mar 2023 Corp exFincl",
  "Global X Guru",
  "AdvisorShares STAR Global Buy-Write",
  "Rogers Intl Commodity Metal",
  "IQ Hedge Macro Tracker",
  "iShares MSCI Belgium",
  "WBI Tactical LCV",
  "VanEck Vectors Energy Income",
  "ProShares Ultra MSCI EAFE",
  "VanEck Vectors ChinaAMC SME-ChiNext",
  "ProShares Ultra Telecom. ProShares",
